...
import {
  el, ensureMusic, drawPortrait, statBarsHTML, charDef, charName, charTitle,
  PortraitRail,
} from '../uiKit.js'
...
export class GalleryScreen {
  ...
  enter() {
    ...
    this.root.innerHTML = `
      ...
      <div class="wcs-hintbar"><b>&larr;&rarr;</b> BROWSE &nbsp; <b>K</b> COSTUME &nbsp; <b>ESC</b> BACK</div>
    `
  ...
  _show(id, i) {
    ...
    drawPortrait(this.portrait, id, { locked: !def })
  ...
  _applyCostume() {
    ...
    // cheap-and-cheerful alt-palette preview: hue-shift the portrait
